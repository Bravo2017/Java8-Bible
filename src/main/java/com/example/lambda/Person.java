...
public class Person {
  ...
  private void initPrintMap(){
    ...
    Function<Person, String> gangnamNameAgePhone = p ->
    ...
    Function<Person, String> fullGangnam =  p -> "\nName: " + p.getSurName() + " " 
            + p.getGivenName() + "\n" + "Age: " + p.getAge() + "  " + 
            "Gender: " + p.getGender() + "\n" +
            "EMail: " + p.getEmail() + "\n" + 
            "Phone: " + p.getPhone() + "\n" +
    ...
    printMap.put("gangnamNameAgePhone", gangnamNameAgePhone);
    printMap.put("fullWestern", fullWestern);
    printMap.put("fullGangnam", fullGangnam);
  ...
  /* Lambda Print method */
  public void printl(Function<Person, String> func){
    System.out.println(func.apply(this));
  }
